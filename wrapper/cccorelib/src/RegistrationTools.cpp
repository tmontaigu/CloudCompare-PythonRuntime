...
void define_RegistrationTools(py::module &cccorelib)
{
	...
	py::enum_<CCCoreLib::RegistrationTools::TRANSFORMATION_FILTERS>(RegistrationTools, "TRANSFORMATION_FILTERS")
	...
	RegistrationTools.def_static("FilterTransformation", &CCCoreLib::RegistrationTools::FilterTransformation,
	                             "inTrans"_a, "transformationFilters"_a,
	                             "outTrans"_a);


	py::class_<CCCoreLib::HornRegistrationTools, CCCoreLib::RegistrationTools>(cccorelib, "HornRegistrationTools")
			.def_static("FindAbsoluteOrientation", &CCCoreLib::HornRegistrationTools::FindAbsoluteOrientation,
			            "lCloud"_a, "rCloud"_a, "trans"_a, "fixedScale"_a = false)
			.def_static("ComputeRMS", &CCCoreLib::HornRegistrationTools::ComputeRMS, "lCloud"_a, "rCloud"_a, "trans"_a);


	py::class_<CCCoreLib::ICPRegistrationTools, CCCoreLib::RegistrationTools> ICPRegistrationTools(cccorelib,
	                                                                                               "ICPRegistrationTools");

	ICPRegistrationTools.def_static("Register", &CCCoreLib::ICPRegistrationTools::Register, "modelCloud"_a,
	                                "modelMesh"_a, "dataCloud"_a, "params"_a, "totalTrans"_a, "finalRMS"_a,
	                                "finalPointCount"_a, "progressCb"_a = nullptr);

	py::enum_<CCCoreLib::ICPRegistrationTools::CONVERGENCE_TYPE>(ICPRegistrationTools, "CONVERGENCE_TYPE")
			.value("MAX_ERROR_CONVERGENCE", CCCoreLib::ICPRegistrationTools::CONVERGENCE_TYPE::MAX_ERROR_CONVERGENCE)
			.value("MAX_ITER_CONVERGENCE", CCCoreLib::ICPRegistrationTools::CONVERGENCE_TYPE::MAX_ITER_CONVERGENCE)
			.export_values();
	...
	py::enum_<CCCoreLib::ICPRegistrationTools::RESULT_TYPE>(ICPRegistrationTools, "RESULT_TYPE")
			...
			.value("ICP_ERROR_INVALID_INPUT", CCCoreLib::ICPRegistrationTools::RESULT_TYPE::ICP_ERROR_INVALID_INPUT)
			.export_values();
	...
	py::class_<CCCoreLib::ICPRegistrationTools::Parameters>(ICPRegistrationTools, "Parameters")
			...
			.def_readwrite("transformationFilters", &CCCoreLib::ICPRegistrationTools::Parameters::transformationFilters)
			.def_readwrite("maxThreadCount", &CCCoreLib::ICPRegistrationTools::Parameters::maxThreadCount);


	py::class_<CCCoreLib::FPCSRegistrationTools, CCCoreLib::RegistrationTools>(cccorelib, "FPCSRegistrationTools")
			.def_static("RegisterClouds", &CCCoreLib::FPCSRegistrationTools::RegisterClouds,
			            "modelCloud"_a, "dataCloud"_a, "transform"_a, "delta"_a, "beta"_a, "overlap"_a, "nbBases"_a,
			            "nbTries"_a, "progressCb"_a = nullptr, "nbMaxCandidates"_a = 0);
}