...
void define_DgmOctree(py::module &cccorelib)
{
    ...
    PyDgmOctree.def_static("GET_BIT_SHIFT", &CCCoreLib::DgmOctree::GET_BIT_SHIFT, "level"_a)
        ...
        .def(
            "build",
            [](CCCoreLib::DgmOctree &self, CCCoreLib::GenericProgressCallback *progressCb = nullptr) {
                return self.build();
            },
            "progressCb"_a = nullptr)
        .def(
            "build",
            [](CCCoreLib::DgmOctree &self,
        ...
        .def("getMinFillIndexes",
             &CCCoreLib::DgmOctree::getMinFillIndexes,
             "level"_a,
             py::return_value_policy::reference)
        .def("getMaxFillIndexes",
             &CCCoreLib::DgmOctree::getMaxFillIndexes,
             "level"_a,
             py::return_value_policy::reference)
    ...
    py::class_<CCCoreLib::DgmOctree::NearestNeighboursSearchStruct>(PyDgmOctree,
