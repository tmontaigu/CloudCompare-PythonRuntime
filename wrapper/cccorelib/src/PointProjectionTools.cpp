...
void define_PointProjectionTools(py::module &cccorelib)
{
	...
	PointProjectionTools
			.def_static("developCloudOnCylinder", &CCCoreLib::PointProjectionTools::developCloudOnCylinder,
			            "cloud"_a, "radius"_a, "dim"_a = 2, "center"_a = nullptr, "progressCb"_a = nullptr)
			.def_static("developCloudOnCone", &CCCoreLib::PointProjectionTools::developCloudOnCone,
			            "cloud"_a, "dim"_a, "baseRadius"_a, "alpha"_a, "center"_a, "progressCb"_a = nullptr)
			.def_static("applyTransformation", &CCCoreLib::PointProjectionTools::applyTransformation,
			            "cloud"_a, "trans"_a, "progressCb"_a = nullptr)
			.def_static("computeTriangulation", &CCCoreLib::PointProjectionTools::computeTriangulation,
			            "cloud"_a, "type"_a, "maxEdgeLength"_a, "dim"_a, "outputErrorStr"_a);
