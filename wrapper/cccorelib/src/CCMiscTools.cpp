...
void define_CCMiscTools(py::module &cccorelib) {
	...
	CCMiscTools.def_static("ComputeBaseVectors", (void (*)(const CCVector3 &, CCVector3 &,
	                                                       CCVector3 &)) (&CCCoreLib::CCMiscTools::ComputeBaseVectors), "N"_a, "X"_a, "Y"_a);

	CCMiscTools.def_static("ComputeBaseVectors", (void (*)(const CCVector3d &, CCVector3d &,
