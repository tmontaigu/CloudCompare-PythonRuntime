...
class GenericCloud:
    ...
    def setPointScalarValues(self, action: Callable[[float],None]) -> None: ...
...
class Neighbourhood:
    GeomElement: Any = ...
    FLAG_DEPRECATED: Any = ...
    FLAG_GRAVITY_CENTER: Any = ...
    FLAG_LS_PLANE: Any = ...
    FLAG_QUADRIC: Any = ...
    CurvatureType: Any = ...
    GAUSSIAN_CURV: Any = ...
    MEAN_CURV: Any = ...
    NORMAL_CHANGE_RATE: Any = ...
    InputVectorsUsage: Any = ...
    UseOXYasBase: Any = ...
    UseYAsUpDir: Any = ...
    NONE: Any = ...
    GeomFeature: Any = ...
    ...
    PCA1: Any = ...
    PCA2: Any = ...
    SurfaceVariation: Any = ...
    Sphericity: Any = ...
    Verticality: Any = ...
    EigenValue1: Any = ...
    EigenValue2: Any = ...
    EigenValue3: Any = ...
    IGNORE_MAX_EDGE_LENGTH: Any = ...
    DUPLICATE_VERTICES: Any = ...
    DO_NOT_DUPLICATE_VERTICES: Any = ...
    def __init__(self, associatedCloud: GenericIndexedCloudPersist) -> None: ...
    def associatedCloud(self) -> GenericIndexedCloudPersist: ...
    def compute3DQuadric(self) -> Any: ...
    def computeCovarianceMatrix(self) -> SquareMatrixd: ...
    def computeCurvature(self, P: CCVector3, cType: Any) -> float: ...
    def computeFeature(self, feature: Any) -> float: ...
    def computeLargestRadius(self) -> float: ...
    def computeMomentOrder1(self, P: CCVector3) -> float: ...
    def computeRoughness(self, P: CCVector3, roughnessUpDir: CCVector3 = ...) -> float: ...
    def getGravityCenter(self) -> Any: ...
    def getLSPlane(self) -> Any: ...
    def getLSPlaneNormal(self) -> Any: ...
    def getLSPlaneX(self) -> Any: ...
    def getLSPlaneY(self) -> Any: ...
    def getQuadric(self) -> Any: ...
    def projectPointsOn2DPlane(self, *args, **kwargs) -> Any: ...
    def reset(self) -> None: ...
    def setGravityCenter(self, G: CCVector3) -> None: ...
    def setLSPlane(self, *args, **kwargs) -> None: ...
    def triangulateFromQuadric(self, stepsX: int, stepsY: int) -> GenericIndexedMesh: ...
    def triangulateOnPlane(self, duplicateVertices: bool, maxEdgeLength: float) -> Any: ...
...
class SquareMatrix:
    ...
    def setValue(self, row: int, column: int, value: float) -> None: ...
    ...
    def __iadd__(self, other: SquareMatrix) -> SquareMatrix: ...
    def __isub__(self, other: SquareMatrix) -> SquareMatrix: ...
...
class SquareMatrixd:
    ...
    def setValue(self, row: int, column: int, value: float) -> None: ...
    def getValue(self, row: int, column: int) -> float: ...
    def __add__(self, other: SquareMatrixd) -> SquareMatrixd: ...
    def __sub__(self, other: SquareMatrixd) -> SquareMatrixd: ...
    def __iadd__(self, other: SquareMatrixd) -> SquareMatrixd: ...
    def __isub__(self, other: SquareMatrixd) -> SquareMatrixd: ...
